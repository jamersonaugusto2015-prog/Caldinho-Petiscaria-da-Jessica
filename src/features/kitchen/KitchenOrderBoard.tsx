      ...
      <div className="space-y-4 sm:space-y-5">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-3 sm:gap-4 items-start">
          <Panel title="Pedidos recentes">
            ...
            {/* `overscroll-contain`: chegar ao fim da lista e continuar puxando
                arrastava a página do painel inteira no iOS. */}
            <div className="max-h-80 overflow-y-auto overscroll-contain -mx-1 px-1">
