import type { Fulfillment, PaymentDetails, PaymentMethod, PaymentTiming } from '../order/types';
...
export function paymentLabel(
  ...
  // Um `method` fora do esperado (linha antiga, integração futura) não pode
  // virar "undefined online" na tela da cozinha.
  return `${PAYMENT_METHOD_LABEL[payment.method] ?? 'Pagamento'} ${timingLabel(payment, fulfillment)}`;
}
