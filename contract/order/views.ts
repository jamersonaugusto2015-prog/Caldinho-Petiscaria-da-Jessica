...
export function stripCustomerContact(order: Order): Order {
  return {
    ...
    // Texto livre do cliente vaza contato com frequência ("faltou o refri,
    // meu telefone é 81 9..."). Nada dele pertence ao pool de corridas.
    ratingComment: undefined,
    complaint: undefined,
    cancellationReason: undefined,
    cancellationRequest: undefined,
    // Identificadores internos do pagamento não ajudam a decidir corrida
    // nenhuma — e `mpTicketUrl` abre a página de pagamento do cliente.
    payment: {
      ...order.payment,
      pixCopyPaste: undefined,
      pixQrCode: undefined,
      mpPaymentId: undefined,
      mpTicketUrl: undefined,
